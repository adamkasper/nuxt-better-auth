...
::note
The module automatically injects `secret` from `NUXT_BETTER_AUTH_SECRET` and `baseURL` from `NUXT_PUBLIC_SITE_URL`. You don't need to configure these in `defineServerAuth`.
::
